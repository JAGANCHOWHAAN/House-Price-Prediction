...
Original file is located at
    https://colab.research.google.com/drive/1FfVTjRLUJrKJHaAK9q3-zr55wQxyAWTP
"""
...
path = "https://drive.google.com/file/d/1YcGvs8uBUat1MbWH8J8Ubdj6Jd8Jyq4U/view?usp=share_link"
...
delimiter = ','
max_columns = max(open("https://drive.google.com/file/d/1YcGvs8uBUat1MbWH8J8Ubdj6Jd8Jyq4U/view?usp=share_link", 'r'), key = lambda x: x.count(delimiter)).count(delimiter)
df = pd.read_csv("https://drive.google.com/file/d/1YcGvs8uBUat1MbWH8J8Ubdj6Jd8Jyq4U/view?usp=share_link", header = None, skiprows = 1, names = list(range(0,max_columns)))

from google.colab import files
upload = files.upload()

import io
df2 = pd.read_csv(io.BytesIO(upload['Bengaluru_House_Data.csv']))
